...
function App() {
  ...
  const procedures: Procedure[] = [
    ...
    { name: 'Mega Volume', price: 'R$ 180,00', image: 'WhatsApp Image 2025-11-29 at 20.21.39 (1).jpeg' },
